            ...
            <div class="row">
                <div class="col-sm-6 text-white">
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-0 pt-0 pt-xl-0 mt-xl-n0"> <!-- Modificado el margen y relleno aquí -->
                        <form action="{{route('inicia-sesion')}}" method="post" style="width: 23rem;">
                            @csrf
                            ...
                            <div class="pt-1 mb-4">
                                <button data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-light btn-lg px-5" type="submit">Log in</button>
                            </div>
                        </form>
                    </div>
                </div>
